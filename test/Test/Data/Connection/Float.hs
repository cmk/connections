...
module Test.Data.Function.Connection where

import Data.Function.Connection

import qualified Data.Function.Connection.Property as Prop
...
rf :: Range Float
rf = R.exponentialFloatFrom 0 (-3.40282347e38) 3.40282347e38
...
gen_float :: Gen Float
gen_float = G.frequency [(9, G.float rf), (1, gen_ex)] 
