//! Kani harnesses for 4-byte sortable big-endian byte encodings.
...
prove_iso_be!(u032_be, crate::fixed::u032::U032BE04, u32);
prove_iso_be!(i032_be, crate::fixed::i032::I032BE04, i32);
