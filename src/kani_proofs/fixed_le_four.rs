//! Kani harnesses for 4-byte sortable little-endian byte-encoding isos.
...
prove_iso_le!(u032_le, crate::fixed::u032::U032LE04, u32);
prove_iso_le!(i032_le, crate::fixed::i032::I032LE04, i32);
