...
//!
//! Coverage strategy: same as `fix_fix_signed.rs` — full ladder for
//! u8/u16, boundary pairs for wider widths.
...
// ── u8-backed (10 representative pairs × 5 props = 50 proofs; see
//     module header for coverage rationale) ────────────────────────
...
// ── u16-backed (boundary subset for typical audio formats) ──────────
