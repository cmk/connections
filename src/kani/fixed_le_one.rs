//! Kani harnesses for 1-byte little-endian byte encodings.
...
prove_iso_le!(u008_le, crate::core::u008::U008LE01, u8);
prove_iso_l2!(i008_le, crate::core::i008::I008LE01, i8);
...
mod bool_le {
    ...
    fn host_roundtrip_l() {
        let a = any_bool();
        assert!(conn_laws::iso_roundtrip_l(&crate::core::bool::BOOLLE01, a));
    }
    ...
    fn order_preserving() {
        ...
        assert!(
            a.cmp(&b)
                == crate::conn::ceil(&crate::core::bool::BOOLLE01, a)
                    .cmp(&crate::conn::ceil(&crate::core::bool::BOOLLE01, b))
        );
    }
}
