...
joinWith :: ConnL (a, a) b -> a -> a -> b
joinWith = curry . ceilingWith
{-# INLINE joinWith #-}
...
meetWith :: ConnR (a, a) b -> a -> a -> b
meetWith = curry . floorWith
{-# INLINE meetWith #-}
...
extend :: ConnL a (Maybe b) -> ConnL (Extended a) (Extended b)
extend (ConnL f g) = ConnL f' g' where
  f' = extended Bottom Top $ maybe Bottom Extended . f
  g' = extended (Extended $ g Nothing) Top $ Extended . g . Just
{-# INLINE extend #-}
