...
mod tests {
    ...
    // The f32/f64 → Q-format Galois proptest battery (154 generated
    // tests across 14 Conns; 7 L-only under f32, 7 full-triple
    // under f64) lives in `tests/fixed_u32_float_q_galois.rs`.
}
